...
class UserCreate(generic.CreateView):
    ...
    def form_valid(self, form):
        ...
        subject = render_to_string('register/mail_template/create/subject.txt', context).replace('\n','')
...
class UserList(LeaderMixin, generic.ListView):
    """ユーザーリスト"""
    model = User
    ...
    def get_queryset(self):
        user = self.request.user
        return User.objects.filter(team_name=user.team_name, is_active=True).order_by("is_leader")
